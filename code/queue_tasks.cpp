...
int main() {
    ...
    FSS_tasks.push("Охрана прав, свобод и законных интересов граждан, обеспечение правильного развития человеческой личности");
    FSS_tasks.push("Создание необходимых условий для выполнении функций государственных органов");
