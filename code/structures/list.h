...
class LinkedList {
 ...
 public:
  ...
  LinkedList
  createEmptyLinkedList();       // a function that creates an empty linked list
  void add(const string& data);  // a function that adds a new node with a value
                                 // to the beginning of the linked list
  void addToEnd(const string& data);  // a function that adds a new node with a
                                      // value to the end of the linked list
  void remove(
      string& element);  // Function to remove the first element from the list
  int removeByValue(
      const string& value);  // Function to remove the first occurrence of a
                             // specific value from the list
  int search(const string& element);  // Function to search for the index of a
