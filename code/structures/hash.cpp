...
// Function to insert or update a key-value pair in the hash table, eliminating duplicates
void HashTable::set(const string& key, const string& value) {
    ...
    while (current != nullptr) {
        if (current->key == key) {
            // An element with such a key already exists, update the value and terminate the function
    ...
    // There is no element with this key, adding a new element to the end of the chain
